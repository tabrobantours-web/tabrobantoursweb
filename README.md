...
## Content edit update
Applied the approved copy changes from Tabrobane website edits.docx. No layout, animation, logo, fleet or responsive design changes were made.

## Mobile section repair
- Fixed Tour Finder clipping/overflow on narrow mobile screens.
- Handpicked Journeys is now always visible on mobile as a touch-friendly horizontal carousel.
- Kept GSAP parallax/reveal motion on the Handpicked imagery without fragile mobile pinning.
- Your Private Ride is now always visible on mobile as a vertical real-vehicle sequence.
- Each vehicle receives a GSAP right-to-left entrance/parallax effect as the user scrolls.
- Desktop pinned GSAP behavior remains unchanged.

## Contact information update
- Phone / WhatsApp: +94 71 993 3933
- Email: tabrobantours@gmail.com
- Updated footer contact details across every page.
- Updated floating WhatsApp button to open a chat with +94 71 993 3933.
- Updated contact, partnership and trip-planning forms to prepare email messages addressed to tabrobantours@gmail.com.

## Plan My Trip email delivery fix
The Plan My Trip form now submits directly to:
`tabrobantours@gmail.com`

Implementation:
- Form action: `https://formsubmit.co/tabrobantours@gmail.com`
- Method: POST
- The previous `mailto:` JavaScript interception was removed.
- All entered trip-planning fields are sent in a table-formatted email.
- Spam honeypot and CAPTCHA-disabled configuration are included.

IMPORTANT FIRST-TIME ACTIVATION:
FormSubmit normally sends a one-time activation email to
`tabrobantours@gmail.com` after the first form submission.
Open that email and click the activation/confirmation link once.
After activation, future website submissions are delivered directly to
`tabrobantours@gmail.com`.
